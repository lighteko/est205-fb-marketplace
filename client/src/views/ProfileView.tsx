  ...
  return (
    <>
      ...
      >
        ...
        <div
          style={{ marginTop: "12px", textAlign: "center", padding: "0 16px" }}
        >
          <h2 style={{ fontSize: "22px", fontWeight: "700", margin: "8px 0" }}>
            John Doe <span style={{ color: "#007BFF" }}>✔</span>
          </h2>
        ...
        >
          ...
          <p style={{ margin: "8px 0", fontSize: "14px" }}>
            💬 Response Rate:{" "}
            <span style={{ color: "#777" }}>Not enough data</span>
          </p>
        </div>
