...
import johnDoe from "./../assets/icons/johnDoe.svg";
import cybertruck from "./../assets/icons/cybertruck.svg";
import picture1 from "./../assets/icons/picture1.svg";
import picture2 from "./../assets/icons/picture2.svg";
...
export default function ProfileView(): JSX.Element {
  return (
    <div
      style={{
        maxWidth: "400px",
        margin: "16px auto", // Add margin for the outer container
